  ...
  const promotionData = [
    {
      ...
      reason: 'Outstanding performance in Q1 and Q2',
      approvalDate: '10-08-2025',
      approverName: 'HR Manager',
      approverComments: 'Well deserved!',
    ...
    },
    {
      ...
      reason: 'Promotion due to certification and experience',
      approvalDate: '11-08-2024',
      approverName: 'Finance Director',
      approverComments: 'Excellent progress',
      finalApproval: 'Approved',
    },
    {
      id: 3,
      ...
      newDepartment: 'HR',
      newDesignation: 'Senior HR Manager',
      reason: 'Leadership in key hiring campaigns',
      approvalDate: '12-08-2025',
      approverName: 'CEO',
      approverComments: 'Strategic contributor',
      finalApproval: 'Approved',
    },
  ];

  const filteredData = promotionData.filter(entry =>
    entry.employee.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
    entry.newDepartment.toLowerCase().includes(searchTerm.toLowerCase())
  );
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">New Department</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">New Designation</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">Final Approval</th>
              </tr>
            </thead>
                ...
                <tr key={entry.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td
                    className={`px-6 py-4 whitespace-nowrap text-sm font-semibold ${
                      entry.finalApproval === 'Approved' ? 'text-green-600' : 'text-red-600'
                    }`}
                  >
                    {entry.finalApproval}
                  </td>
