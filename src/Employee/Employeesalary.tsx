        ...
        <div className="overflow-x-auto scrollbar-custom">
          <table className="w-full custom-font">
            <thead className="bg-gray-50/50">
              <tr>
                <th className="px-6  w-[80px] text-left text-xs font-medium text-gray-500 uppercase">S.No</th>
                <th className="px-6  w-[80px] text-left text-xs font-medium text-gray-500 uppercase">Order</th>
                <th className="px-6   w-[80px] text-left text-xs font-medium text-gray-500 uppercase">Earnings</th>
             
                <th className="px-6   w-[150px] text-left text-xs font-medium text-gray-500 uppercase">Type</th>
              <th className="px-6   w-[200px] text-left text-xs font-medium text-gray-500 uppercase">Amount %</th>

                <th className="px-6  w-[200px] text-left text-xs font-medium text-gray-500 uppercase">Line of value</th>
                <th className="px-6  w-[80px] text-left text-xs font-medium text-gray-500 uppercase">Amount</th>
             <th className="px-6   w-[120px] text-left text-xs font-medium text-gray-500 uppercase">Annual</th>
