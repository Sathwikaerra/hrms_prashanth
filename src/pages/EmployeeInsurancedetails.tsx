          ...
          <table className="w-full custom-font">
            <thead className="bg-gray-50/50">
              <tr>
                ...
                <th className="px-6   w-[80px] text-left text-xs font-medium text-gray-500 uppercase"> Name</th>
                <th className="px-6   w-[150px] text-left text-xs font-medium text-gray-500 uppercase">Age</th>
