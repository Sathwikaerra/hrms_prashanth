          ...
          <table className="w-full custom-font">
            <thead className="bg-gray-50/50">
              <tr>
                ...
                <th className="px-6   w-[80px] text-left text-xs font-medium text-gray-500 uppercase">Organization Name</th>
                <th className="px-6   w-[150px] text-left text-xs font-medium text-gray-500 uppercase">Designation</th>
                <th className="px-6   w-[200px] text-left text-xs font-medium text-gray-500 uppercase">Joining Date</th>
                <th className="px-6  w-[200px] text-left text-xs font-medium text-gray-500 uppercase">Relieving date</th>
                <th className="px-6  w-[80px] text-left text-xs font-medium text-gray-500 uppercase">Location</th>
                <th className="px-6   w-[120px] text-left text-xs font-medium text-gray-500 uppercase">CTC</th>
                <th className="px-6   w-[120px] text-left text-xs font-medium text-gray-500 uppercase">Remarks</th>
